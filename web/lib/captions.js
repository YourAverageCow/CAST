...
// transforms the copy of the text handed to the TTS engine (see
// generateSpeech() in app.js) — captions/story text keep showing "AITAH"
// exactly as written; only what gets spoken changes. "AITAH" is matched
// before the shorter "AITA" pattern gets a chance to see it, since
// "AITAH" has no word boundary right after "AITA" — the two patterns
// can't double-match the same span.
