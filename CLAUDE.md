...
Native TTS and native Whisper/VAD-based caption alignment are explicitly not part of this — Piper/Kokoro still run as WASM/ONNX in the browser either way.
